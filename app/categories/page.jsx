  ...
  return (
    <div className="flex relative">
      ...
      <div className="p-8 mx-auto w-full pl-80">
        <h2 className="text-2xl font-semibold text-wallet_red_100">
          Categories
        </h2>
        {Object.entries(categories).map(([category, subcategories]) => (
          <div key={category} className="mt-4">
            ...
            >
              <span className={`mr-2 ${openCategories[category] ? "rotate-90" : ""}`}>
                ▶
              </span>
              <h3 className="text-xl text-wallet_black">{category.toUpperCase()}</h3>
            </div>
